...
public class EditCustomerPageUI {
	...
	public static final String DOB_BOX = "//input[@id='dob']";
	...
	public static final String REGISTERED_MSG = "//p[text()='Customer Registered Successfully!!!']";
	public static final String CUSTOMER_ID = "//td[text()='Customer ID']/following-sibling::td";
	
	public static final String UPDATED_MSG = "//p[text()='Customer details updated Successfully!!!']";
}
